...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Train Prithvi Segmentation model')
...
args.log_dir = f'./logs/prithvi_{args.version}'
...
def main(args):
    ...
    if args.prithvi_finetune_ratio is not None:
