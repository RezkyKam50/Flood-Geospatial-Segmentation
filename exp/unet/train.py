...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Train a UNet Segmentation model')
...
args.log_dir = f'./logs/unet_{args.version}'
...
def main(args):
    ...
    logger.info(f"Using UNet model")
